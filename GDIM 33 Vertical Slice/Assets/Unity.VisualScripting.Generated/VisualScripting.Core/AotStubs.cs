...
namespace Unity.VisualScripting.Generated.Aot
{
	...
	public class AotStubs
	{
		...
		// Enemy.TakeDamage
		[global::UnityEngine.Scripting.PreserveAttribute()]
		public static void Enemy_TakeDamage()
		{
			global::Enemy target = default(global::Enemy);
			int arg0 = default(int);
			target.TakeDamage(arg0);
			global::Unity.VisualScripting.InstanceActionInvoker<Enemy, int> optimized = new global::Unity.VisualScripting.InstanceActionInvoker<Enemy, int>(default(global::System.Reflection.MethodInfo));
			optimized.Invoke(default(global::Enemy), arg0);
			optimized.Invoke(default(object[]));
		}
